...
public class GupshupMock {
    ...
    public String getSmsMockedResponse(String messageId) {
    	return  SMS_MOCKED_RESPONSES.get(messageId);
    }
    
    public String getSmsDeliveryStatusMockedResponse(String messageid) {
        return SMS_DELIVERY_STATUS_MOCKED_RESPONSES.get(messageid);
    }

   

    public  String getPnMockedResponses(String token) {
		return PN_MOCKED_RESPONSES.get(token);
	}

	public String getEmailMockedResponse() {
